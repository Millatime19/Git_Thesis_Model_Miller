function [BC, dt, dt_max, ttot, VIMS_Exhaust, n_Soil_Contam,ntsteps,W_Deg] = Stress_Periods(Conc_Soil_1,Conc_Soil_2,Contam_Soil,...
    ...
    Max_Days = 3300; % Total Model Runtime (Days) Sim = 3300 days. 43 years = 15705 days. 
    ...
    if VIMS_Present == 0 
        ...
        BC_2_End = VIMS_Days; % End of VIMS/Just after last Sampling Event (1/3/2024 - 2638)
    ...
    dt = 0.5 * 86400;  dt_max = 1 * 86400;   % Timestep min and max seconds
