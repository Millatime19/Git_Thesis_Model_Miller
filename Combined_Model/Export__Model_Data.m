function [Model_Data_Export] = Export__Model_Data(current_run,Figure_Count,theta,theta_bare , Conc_Soil_1,...
    ...
    MW, VIMS_Exhaust, G_new, G_ug_m3, nin, BC, Building_Model, Sim_ID, dx, SDENS, MC, MC_Before);
    ...
    Model_Export.MC_Before = MC_Before; 
    % Model_Export.I = I; 
    Model_Export.L = L; 
